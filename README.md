...
![License](https://img.shields.io/badge/License-EPL--1.0-orange)
...
| **LDAP Integration** | python-ldap | 3.4.4 |
...
http://localhost:8081/api/docs    # Docker
```
...
Auto-generated **OpenAPI 3.x / Swagger** documentation is available at `/api/docs` when the application is running. The documentation is generated by [flask-smorest](https://flask-smorest.readthedocs.io/) from the registered Flask Blueprints.
...
This project is licensed under the **Eclipse Public License 1.0 (EPL-1.0)**. See the [LICENSE](LICENSE) file for details.
